...
class RepresentationStore:
    """Refreshable read model for discovered units and parsed representations."""
    ...
    def __init__(
        ...
        self._refresh_interval_seconds = max(refresh_interval_seconds, 0.25)
    ...
    def _refresh_if_needed(self) -> None:
        ...
        self._units = self._collector.discover_compilation_units(self._data_dir)
        self._units_by_name = {unit.name: unit for unit in self._units}
        self._parsed_units = {}

    def _ensure_unit_parsed(self, unit_name: str) -> None:
        ...
        self._parsed_units[unit_name] = self._collector.parse_compilation_unit(unit)
